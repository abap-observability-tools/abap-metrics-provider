...
*   generation date: 20.11.2020 at 18:49:02
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_SCE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAMPV_CONFIG_SCE_EXTRACT
TOTAL = ZAMPV_CONFIG_SCE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_SCE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAMPV_CONFIG_SCE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAMPV_CONFIG_SCE_EXTRACT
TOTAL = ZAMPV_CONFIG_SCE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAMPV_CONFIG_SCE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_SCE'
...
TOTAL = ZAMPV_CONFIG_SCE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAMPV_CONFIG_SCE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAMPV_CONFIG_SCE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_SCE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZAMPV_CONFIG_SCE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAMPV_CONFIG_SCE_EXTRACT
TOTAL = ZAMPV_CONFIG_SCE_TOTAL
