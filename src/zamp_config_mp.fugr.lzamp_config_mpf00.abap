...
ZAMPV_CONFIG_PRO-METRIC_GROUP_NAME =
ZAMP_CONFIG_PROV-METRIC_GROUP_NAME .
ZAMPV_CONFIG_PRO-METRIC_CLASS =
ZAMP_CONFIG_PROV-METRIC_CLASS .
ZAMPV_CONFIG_PRO-SCENARIO =
ZAMP_CONFIG_PROV-SCENARIO .
...
IF STATUS_ZAMPV_CONFIG_PRO-ST_DELETE EQ GELOESCHT.
  ...
  METRIC_GROUP_NAME = ZAMPV_CONFIG_PRO-METRIC_GROUP_NAME .
    IF SY-SUBRC = 0.
...
FORM CORR_MAINT_ZAMPV_CONFIG_PRO USING VALUE(CM_ACTION) RC.
  ...
  CLEAR RC.
MOVE ZAMPV_CONFIG_PRO-METRIC_GROUP_NAME TO
ZAMP_CONFIG_PROV-METRIC_GROUP_NAME .
  CORR_KEYTAB             =  E071K.
...
ZAMPV_CONFIG_SCE-SCENARIO =
ZAMP_CONFIG_SCEN-SCENARIO .
...
IF STATUS_ZAMPV_CONFIG_SCE-ST_DELETE EQ GELOESCHT.
  ...
  SCENARIO = ZAMPV_CONFIG_SCE-SCENARIO .
    IF SY-SUBRC = 0.
...
FORM CORR_MAINT_ZAMPV_CONFIG_SCE USING VALUE(CM_ACTION) RC.
  ...
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZAMPV_CONFIG_SCE-SCENARIO TO
ZAMP_CONFIG_SCEN-SCENARIO .
  CORR_KEYTAB             =  E071K.
