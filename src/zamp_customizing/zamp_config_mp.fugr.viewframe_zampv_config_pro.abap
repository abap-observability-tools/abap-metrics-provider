*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAMPV_CONFIG_PRO
*   generation date: 02.03.2021 at 21:36:14
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAMPV_CONFIG_PRO    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_PRO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAMPV_CONFIG_PRO_EXTRACT
TOTAL = ZAMPV_CONFIG_PRO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_PRO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAMPV_CONFIG_PRO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAMPV_CONFIG_PRO_EXTRACT
TOTAL = ZAMPV_CONFIG_PRO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAMPV_CONFIG_PRO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_PRO'
...
TOTAL = ZAMPV_CONFIG_PRO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAMPV_CONFIG_PRO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAMPV_CONFIG_PRO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZAMPV_CONFIG_PRO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZAMPV_CONFIG_PRO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAMPV_CONFIG_PRO_EXTRACT
TOTAL = ZAMPV_CONFIG_PRO_TOTAL
